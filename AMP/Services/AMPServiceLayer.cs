    ...
    public class AMPServiceLayer : IAmpServiceLayer, IDisposable
    {
        ...
        public async Task<ProjectVM> GetProjectVM(string ProjectID, string user)
        {
            ...
            if (project != null)
            {
                ...
                IEnumerable<WorkflowMaster1> projectWorkflows = project.WorkflowMaster1;

                //Find the latest Close Project Workflow
                WorkflowMaster1 latestWorkflow = new WorkflowMaster1();
        ...
        private async Task<WorkflowMasterVM> GetLatestWorkflowResponse(string ProjectID, IEnumerable<WorkflowMaster1> projectWorkflows, int workflowTypeId, string user)
        {
            WorkflowMaster1 latestWorkflow = new WorkflowMaster1();
            WorkflowMaster1 workflowResponse = new WorkflowMaster1();
            WorkflowMaster1 workflowRequest = new WorkflowMaster1();
            ...
            else if (latestWorkflow.StageID == 2 && latestWorkflow.Status == "C")
            {
                ...
                //Map 
                Mapper.Map<WorkflowMaster1, WorkflowMasterVM>(latestWorkflow, WorkflowResponseVM);
        ...
        private async Task<WorkflowMasterVM> GetLatestWorkflowRequest(string projectId, IEnumerable<WorkflowMaster1> projectWorkflows, int workflowTypeId, string user)
        {
            WorkflowMaster1 latestWorkflow = new WorkflowMaster1();
            WorkflowMaster1 workflowRequest = new WorkflowMaster1();
            WorkflowMasterVM WorkflowRequestVM = new WorkflowMasterVM();

            Mapper.CreateMap<WorkflowMaster1, WorkflowMasterVM>();
            ...
            else if (latestWorkflow.StageID == 2 && latestWorkflow.Status == "C")
            {
                ...
                //Map 
                Mapper.Map<WorkflowMaster1, WorkflowMasterVM>(workflowRequest, WorkflowRequestVM);
            ...
            else if (latestWorkflow.StageID == 1 && latestWorkflow.Status == "A")
            {
                ...
                Mapper.Map<WorkflowMaster1, WorkflowMasterVM>(latestWorkflow, WorkflowRequestVM);
        ...
        {
            IEnumerable<WorkflowMaster1> workflowMasters;
            IEnumerable<ReviewMaster> reviewMasters;
            IEnumerable<ReviewDeferral> reviewDeferrals;
            IEnumerable<ReviewExemption> reviewExemptions;
            ...
            workflowMasters = project.WorkflowMaster1;

            //Check for Active Workflow Objects in AMP
            if (project.WorkflowMaster1.Count > 0)
            {
                WorkflowMaster1 projectInWorkflow = new WorkflowMaster1();
